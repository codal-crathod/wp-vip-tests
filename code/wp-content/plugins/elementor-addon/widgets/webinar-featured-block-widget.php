<?php
class Elementor_Webinar_Featured_Block_Widget extends \Elementor\Widget_Base {

	private $stack = array(); // options data

	public function get_name() {
		return 'webinar_featured_block_widget';
	}

	public function get_title() {
		return esc_html__( 'Webinar Featured Block', 'elementor-addon' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'content_section',
			[
				'label' => esc_html__( 'Webinar Featured Block', 'elementor-addon' ),
		...
		$this->stack = $options;
		$this->add_control(
			'webinar_featured_block',
			[
				'label' => esc_html__( 'Please choose webinar to display', 'elementor-addon' ),
				'label_block' => true,
	...
	protected function render() {
		...
		$single_blog = [];
		$blog_id = $settings['webinar_featured_block'];
		if( !$blog_id ) {
		...
		if( $blog_id ) : ?>
			...
			<?php if ( $event ) : ?>
				<div id="webinar-featured-block" class="post-section" data-tag="Webinar" data-webinarID="<?php echo (int) $blog_id; ?>">
					<div class="post-img">
